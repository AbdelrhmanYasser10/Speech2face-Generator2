...
def rm_sil(voice_file, vad_obj,sample_w,channel_np):
    """
    ...
    """
    audio, sample_rate = read_wave(voice_file,channel_np,sample_w)
...
def voice2face(e_net, g_net, voice_file, vad_obj, mfc_obj,sample_w , channel_no, GPU=True):
    vad_voice = rm_sil(voice_file, vad_obj,sample_w , channel_no)
