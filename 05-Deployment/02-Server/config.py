...
NETWORKS_PARAMETERS_FEMALE = {
    ...
    'g': {
        ...
        'channels': [1024, 512, 256, 128, 64],
        'output_channel': 3,  # images with RGB channels
        'model_path': 'female_model/generator.pth',
    },
    # FACE EMBEDDING NETWORK (f)
    'f': {
        'network': FaceEmbedNet,
        ...
        'channels': [32, 64, 128, 256, 512],
        'output_channel': 64,
        'model_path': 'female_model/face_embedding.pth',
    },
    # DISCRIMINATOR (d)
    'd': {
        'network': Classifier,  # Discrminator is a special Classifier with 1 subject
        ...
        'channels': [],
        'output_channel': 1,
        'model_path': 'female_model/discriminator.pth',
    },
    # CLASSIFIER (c)
    'c': {
        'network': Classifier,
        ...
        'channels': [],
        'output_channel': -1,  # This parameter is depended on the dataset we used
        'model_path': 'female_model/classifier.pth',
    },
    # OPTIMIZER PARAMETERS
    'lr': 0.0002,
    'beta1': 0.5,
